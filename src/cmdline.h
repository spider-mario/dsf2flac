...
struct gengetopt_args_info
{
  ...
  int scale_arg;	/**< @brief Scale adjustment. Raw DSD has a modulation depth of approximately 0.5 so with no scaling the PCM peak level is approximately -6dB below 0dBFs (default='2').  */
